...
# Conjoint analysis is a survey-based statistical technique used in market
...
# to survey respondents and by analyzing how they make preferences between these
...
# 1. place the spine chart code file <R_utility_program_1.R>
...
provider.survey <- Lma.design(attribute.names = 
  list(
    brand = c("AT&T","T-Mobile","US Cellular","Verizon"), 
...
# print survey design for review
print(questionnaire(provider.survey))  

# send survey to external text file
